...
data_root = os.path.expanduser('/content/MMA_2/MMA data/train')
data_root_val = os.path.expanduser('/content/MMA_2/MMA data/val')
ann_file_train = os.path.expanduser('/content/MMA_2/MMA data/train_video.txt')
...
train_pipeline = [
    ...
    dict(
        ...
        random_crop=False,
        max_wh_scale_gap=1),
    dict(type='Resize', scale=(1850, 1000), keep_ratio=False),
...
val_pipeline = [
    ...
    dict(type='DecordDecode'),
    dict(type='Resize', scale=(-1, 256)),
    dict(type='CenterCrop', crop_size=1850),
    dict(type='FormatShape', input_format='NCHW'),
    dict(type='PackActionInputs')
]
test_pipeline = [
    ...
    dict(type='DecordDecode'),
    dict(type='Resize', scale=(-1, 256)),
    dict(type='TenCrop', crop_size=1850),
    dict(type='FormatShape', input_format='NCHW'),
    dict(type='PackActionInputs')
]
...
load_from = os.path.expanduser('/content/MMA_2/work_dirs/tsn_ucf101/epoch_30_2.pth')
